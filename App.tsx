...
const App: React.FC = () => {
  ...
  const fixedImages: Record<string, string> = {
    "양하치": "https://gi.esmplus.com/renguard/GodsCT/YANGHACHI.jpg",
    "이제니": "https://gi.esmplus.com/renguard/GodsCT/EGENNIE.jpg",
  };

  // URL → Base64 변환하여 characters[].sheetImage 덮어쓰기
    ...
    <div className="container mx-auto p-4 md:p-8 font-sans bg-amber-50 min-h-screen">
      ...
      <header className="text-center mb-8">
        <h1 className="text-4xl md:text-5xl font-bold text-orange-600" style={{ fontFamily: "'Gugi', cursive" }}>
          이젠오토 4컷 만능 만화 생성기<sup className="text-red-500 text-2xl md:text-3xl ml-1">PRO</sup>
        </h1>
